...
| **Exp-006** | 2026-04-19 | `Exp-006 增加i参数，设置截图帧数 | 多导弹 | 
| **Exp-007** | 2026-04-19 | `Exp-006 增加i参数，设置截图帧数 | 多导弹 | 
...
## 详细数据备份
### Exp-006
- **Code Version**: `| **Exp-006** | 2026-04-19 | `Exp-006 增加i参数，设置截图帧数 | 多导弹 | `
- **Command**: `python main.py`
- **Output**:
			""
...
## 详细数据备份
### Exp-007
- **Code Version**: `| **Exp-007** | 2026-04-19 | `Exp-007 导弹发射存在时间差，导弹不过同一固定点 | 多导弹 | `
- **Command**: `python main.py`
- **Output**:
			""